...
|**Nom**|**Description**|
|:-----|:-----|
|[AccessError](811ef090-bdd4-5d1d-afc5-782470f57483.md)|Vous pouvez utiliser la méthode  **AccessError** pour renvoyer la chaîne descriptive associée à un Microsoft Access ou une erreur DAO.|
|[AddToFavorites](c2024fa1-a972-7798-9bc0-776c6e30c4a4.md)|La méthode  **AddToFavorites** ajoute une adresse de lien hypertexte dans le dossier Favoris.|
|[BuildCriteria](098e9aca-3dc1-ad21-4374-5d8ae7c80c56.md)|La méthode  **BuildCriteria** renvoie une chaîne de critères analysée, telle qu'elle apparaît dans la grille de création de requête, en mode Filtrer par formulaire ou filtrer par formulaire sur serveur. Par exemple, vous souhaiterez peut-être définir un formulaire **Filter** ou **[ServerFilter](18385de5-bc0d-9d2c-f97c-5b42e3689b45.md)** en fonction de divers critères spécifiés par l'utilisateur. Vous pouvez utiliser la méthode **BuildCriteria** pour construire l'argument expression de chaîne pour la propriété **Filter** ou **ServerFilter**. **Chaîne**.|
|[CloseCurrentDatabase](f5dec73c-54b4-c5ea-7cb9-25b5997f539e.md)|Vous pouvez utiliser la méthode  **CloseCurrentDatabase** pour fermer la base de données en cours (une base de données Microsoft Access ou un projet Access (.adp) à partir d'une autre application qui a ouvert une base de données via Automation.|
|[CodeDb](7f0cff23-1265-231f-9ab5-fa83c19d39cf.md)|Vous pouvez utiliser la méthode  **CodeDb est utilisée** dans un module de code pour déterminer le nom de l'objet de **base de données** qui fait référence à la base de données dans laquelle le code est en cours d'exécution. Utilisez la méthode **CodeDb** pour accéder à Data Access Objects (DAO) qui font partie d'une base de données bibliothèque.|
|[ColumnHistory](e2c1b71f-6561-b38d-8173-9926bc4bd9da.md)|Fournit l'historique des valeurs qui ont été stockées dans un champ mémo.|
|[CompactRepair](4820fd79-d907-21bc-0ad5-5fc096c1ef3b.md)|Compacte et répare la base de données spécifiée ou le fichier de projet (.adp) de Microsoft Access. Renvoie un  **type Boolean**; **True** si l'opération a réussi.|
|[ConvertAccessProject](49b865f5-30b6-7b28-efe8-df2cc67951b0.md)|Convertit la version du fichier Microsoft Access spécifié dans une autre version.|
|[CreateAccessProject](66628c62-20db-e3a3-5d27-9da3846f0514.md)|Vous pouvez utiliser la méthode  **CreateAccessProject** pour créer un nouveau projet Microsoft Access (.adp) sur disque.|
|[CreateAdditionalData](d27df827-1bcc-eb1e-00d2-46eebd265440.md)|Crée un objet  **[AdditionalData](2677072b-c2ca-3bcd-fef4-f6b1cadb0379.md)** pouvant être utilisé pour ajouter des tables et des requêtes supplémentaires dans la table parente qui est en cours d'exportation par la méthode **[ExportXML](47627677-d311-c2e1-7532-e8a8a9beef29.md)**.|
|[CreateControl](f5b1689c-62c4-163d-c659-607cee7572f6.md)|La méthode  **CreateControl** crée un contrôle sur un formulaire ouvert spécifié. Par exemple, supposons que vous créez un Assistant personnalisé qui permet aux utilisateurs de créer facilement un formulaire particulier. Vous pouvez utiliser la méthode **CreateControl** de l'Assistant pour ajouter les contrôles appropriés au formulaire.|
|[CreateForm](113c8f7f-baf1-bf5c-85ce-6dc1f3d3e942.md)|La méthode  **CreateForm** crée un formulaire et renvoie un objet **[Form](72ef9219-142b-b690-b696-3eba9a5d4522.md)**.|
|[CreateGroupLevel](880c1e36-b7b5-7ea4-a2ca-d7c3f0a5a7be.md)|Vous pouvez utiliser la méthode  **CreateGroupLevel** pour spécifier un champ ou une expression sur lequel pour regrouper ou trier des données dans un rapport. .|
|[CreateReport](4b086f8c-8017-0b5f-72a7-7c180c32f52d.md)|La méthode  **CreateReport** crée un rapport et renvoie un objet **[Report](6f77c1b4-a9ce-7caa-204c-fe0755c6f9df.md)**. Par exemple, supposons que vous créez un Assistant personnalisé pour créer un rapport des ventes. Vous pouvez utiliser la méthode **CreateReport** dans votre Assistant pour créer un rapport basé sur un modèle de rapport spécifié.|
|[CreateReportControl](4b970377-450b-9909-f5c3-cb7f8445139f.md)|La méthode  **CreateReportControl** crée un contrôle dans un état ouvert spécifié. Pour plus d'informations, voir la méthode **[CreateControl](f5b1689c-62c4-163d-c659-607cee7572f6.md)**.|
|[CurrentDb](defcf58f-7689-90e0-001c-ba5e7e87eb88.md)|La méthode  **CurrentDb** renvoie une variable d'objet de type **Database** qui représente la base de données ouverte actuellement dans la fenêtre Microsoft Access.|
|[CurrentUser](1cf7ee61-459c-1224-cfdf-a0b051eeb06e.md)|Vous pouvez utiliser la méthode  **CurrentUser** pour renvoyer le nom de l'utilisateur actuel de la base de données. .|
|[CurrentWebUser](cb8b230d-71c5-c73d-c88e-1a13246492a5.md)|Obtient des informations sur l'utilisateur actuel d'une base de données WebMicrosoft SharePoint Foundation 2010.|
|[CurrentWebUserGroups](efe80f7a-b6ac-12a5-3704-6e662c87e134.md)|Obtient la collection deMicrosoft SharePoint Foundation 2010groupes dont l'utilisateur est membre.|
|[DAvg](966cd884-8693-d1d2-b35b-567e71b7e56d.md)|Vous pouvez utiliser la fonction  **DAvg** calcule la moyenne d'un ensemble de valeurs dans un jeu d'enregistrements (un domaine) spécifié.|
|[DCount](257f0b2a-e23d-2728-afd2-7700b59e5456.md)|Vous pouvez utiliser la fonction  **DCount** détermine le nombre d'enregistrements dans un jeu d'enregistrements (un domaine).|
|[DDEExecute](9828607e-a2e3-15e2-699a-12fb2dc9e897.md)|Vous pouvez utiliser l'instruction  **DDEExecute** pour envoyer une commande à partir d'une application client à une application serveur via un canal d'échange dynamique de données (DDE) exchange.|
|[DDEInitiate](7b05c3ad-574e-d904-5d50-ff646486ef07.md)|Vous pouvez utiliser la fonction  **DDEInitiate** pour commencer une conversation dynamic data exchange (DDE) avec une autre application. La fonction **DDEInitiate** ouvre un canal DDE pour le transfert de données entre un serveur DDE et une application cliente.|
...
![](images/O12FileMenuButton_ZA10077102.gif)puis en cliquant sur  **Options Access**.  **Variant**.|
...
|[LanguageSettings](f2b039bf-95a8-7820-355e-67fa5e47aaf6.md)|Vous pouvez utiliser la propriété  **LanguageSettings** pour renvoyer une référence en lecture seule à l'objet **LanguageSettings** en cours et à ses propriétés connexes.|
