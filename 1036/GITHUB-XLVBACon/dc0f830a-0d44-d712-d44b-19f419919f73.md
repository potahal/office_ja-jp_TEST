...
|:-----|:-----|:-----|:-----|
| _Arg1_|Obligatoire|**Variant**|Known_y's - the set of y-values you already know in the relationship y = mx + b.|
| _Arg2_|Facultatif|**Variant**|Known_x's - an optional set of x-values that you may already know in the relationship y = mx + b.|
| _Arg3_|Facultatif|**Variant**|Const - a logical value specifying whether to force the constant b to equal 0.|
| _Arg4_|Facultatif|**Variant**|Stats - a logical value specifying whether to return additional regression statistics.|
