...
## Syntax
 ...
 _表达式_. **IncrementBrightness**( ** _Increment_** )
...
|:-----|:-----|:-----|:-----|
| _Increment_|必需|**Single**|Specifies how much to change the value of the  **Brightness** property for the picture. A positive value makes the picture brighter; a negative value makes the picture darker.|
