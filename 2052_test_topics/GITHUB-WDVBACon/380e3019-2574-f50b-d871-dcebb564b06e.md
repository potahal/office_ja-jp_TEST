...
## Syntax
 ...
 _表达式_. **GetCrossReferenceItems**( ** _ReferenceType_** )
...
|:-----|:-----|:-----|:-----|
| _ReferenceType_|必需|**Variant**|The type of item you want to insert a cross-reference to. Can be any  **[WdReferenceType](489c4995-79ba-83e8-5c10-f5863fc11e62.md)** constant.|
