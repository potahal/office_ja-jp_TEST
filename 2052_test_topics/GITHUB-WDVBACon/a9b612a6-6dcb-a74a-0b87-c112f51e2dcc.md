...
## Syntax
 ...
 _表达式_. **Add**( ** _Type_**, ** _Range_** )

 _表达式_ An expression that returns a **ContentControls** object.
...
|:-----|:-----|:-----|:-----|
| _Type_|可选|**[WdContentControlType](6bf57b23-d12f-b942-4a30-cd1deed09407.md)**|Specifies the type of content control to insert into the active document. If omitted, Microsoft Word inserts a rich-text content control.|
| _Range_|可选|**Variant**|Specifies where in the active document to place the content control. If omitted, Word places the content control at the position of the insertion point or replaces the current selection.|
