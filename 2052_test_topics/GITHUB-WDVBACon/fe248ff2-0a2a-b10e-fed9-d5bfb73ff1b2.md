...
## Syntax
 ...
 _表达式_. **ExportAsFixedFormat**( ** _OutputFileName_**, ** _ExportFormat_**, ** _OpenAfterExport_**, ** _OptimizeFor_**, ** _Range_**, ** _From_**, ** _To_**, ** _Item_**, ** _IncludeDocProps_**, ** _KeepIRM_**, ** _CreateBookmarks_**, ** _DocStructureTags_**, ** _BitmapMissingFonts_**, ** _UseISO19005_1_**, ** _FixedFormatExtClassPtr_** )
...
|:-----|:-----|:-----|:-----|
| _OutputFileName_|必需|**String**|The path and file name name of the new PDF or XPS file.|
...
| _Range_|可选|**[WdExportRange](45b45e2d-7eb8-897b-9167-9695000e8ebb.md)**|Specifies whether the export range is the entire document, the current page, a range of text, or the current selection. the default is to export the entire document.|
| _From_|可选|**Long**|Specifies the starting page number, if the Range parameter is set to  **wdExportFromTo**.|
| _To_|可选|**Long**|Specifies the ending page number, if the Range parameter is set to  **wdExportFromTo**.|
