...
|:-----|:-----|:-----|:-----|
| _x_|必需|**Long**|The horizontal distance (in pixels) from the left edge of the screen to the point.|
| _y_|必需|**Long**|The vertical distance (in pixels) from the top of the screen to the point.|
