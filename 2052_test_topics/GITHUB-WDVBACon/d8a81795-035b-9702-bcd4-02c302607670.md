...
## Syntax
 ...
 _表达式_. **Add**( ** _PageNumberAlignment_**, ** _FirstPage_** )
...
|:-----|:-----|:-----|:-----|
| _PageNumberAlignment_|可选|**Variant**|Can be any  **WdPageNumberAlignment** constant.|
| _FirstPage_|可选|**Variant**|**False** to make the first-page header and the first-page footer different from the headers and footers on all subsequent pages in the document. If FirstPage is set to **False**, a page number isn't added to the first page. If this argument is omitted, the setting is controlled by the **DifferentFirstPageHeaderFooter** property.|
