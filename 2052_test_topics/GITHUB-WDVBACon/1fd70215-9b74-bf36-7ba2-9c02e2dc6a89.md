...
## Syntax
 ...
 _表达式_. **SetAllIncludedFlags**( ** _Included_** )
...
|:-----|:-----|:-----|:-----|
| _Included_|必需|**Boolean**|**True** to include all data source records in a mail merge. **False** to exclude all data source records from a mail merge.|
