...
## Syntax
 ...
 _表达式_. **DeleteAllEditableRanges**( ** _EditorID_** )
...
|:-----|:-----|:-----|:-----|
| _EditorID_|可选|**Variant**|Can be either a  **String** that represents the user's e-mail alias (if in the same domain), an e-mail address, or a **WdEditorType** constant that represents a group of users. If omitted, no permissions are deleted from a document.|
