...
|:-----|:-----|:-----|:-----|
| _loc_|必需|**[XlPieSliceLocation](d3a2113f-8779-096c-ce6a-52f29db242b3.md)**|Specifies a horizontal or vertical coordinate.|
| _Index_|可选|**[XlPieSliceIndex](3745028d-34b0-eaff-4437-d5df00b5ce52.md)**|Specifies which pie slice position coordinate to return. The default value is  **xlOuterCenterPoint**.|
