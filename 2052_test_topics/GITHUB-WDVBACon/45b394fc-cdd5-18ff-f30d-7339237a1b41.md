...
## Syntax
 ...
 _表达式_. **OrganizerDelete**( ** _Source_**, ** _Name_**, ** _Object_** )
...
|:-----|:-----|:-----|:-----|
| _Source_|必需|**String**|The file name of the document or template that contains the item you want to delete.|
| _Name_|必需|**String**|The name of the style, AutoText entry, toolbar, or macro you want to delete.|
