...
## Syntax
 ...
 _表达式_. **Add**( ** _Width_**, ** _Spacing_**, ** _EvenlySpaced_** )
...
|:-----|:-----|:-----|:-----|
| _Width_|可选|**Variant**|The width of the new text column in the document, in points.|
| _Spacing_|可选|**Variant**|The spacing between the text columns in the document, in points.|
| _EvenlySpaced_|可选|**Variant**|**True** to evenly space all the text columns be in the document.|
