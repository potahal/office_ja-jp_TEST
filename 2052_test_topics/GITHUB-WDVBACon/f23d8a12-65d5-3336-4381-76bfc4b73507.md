...
|:-----|:-----|:-----|:-----|
| _Layout_|必需|**Long**|The type of layout. The type of layout is denoted by a number from 1 to 10.|
| _ChartType_|可选|**Variant**|An  **[XlChartType](http://msdn.microsoft.com/library/bba4ee89-ee91-f55a-d2e0-59a73e5bfabe%28Office.15%29.aspx)** constant that represents the type of chart.|
