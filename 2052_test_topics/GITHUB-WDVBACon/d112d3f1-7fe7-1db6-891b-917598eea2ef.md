...
## Syntax
 ...
 _表达式_. **Private Sub object_MailMergeWizardStateChange**( ** _ByVal Doc As Document_**, ** _FromState As Long_**, ** _ToState As Long_**, ** _Handled As Boolean_** )
...
| _FromState_|必需|**Long**|The Mail Merge Wizard step from which a user is moving.|
| _ToState_|必需|**Long**|The Mail Merge Wizard step to which a user is moving.|
| _Handled_|必需|**Boolean**|**True** moves the user to the next step. **False** for the user to remain at the current step.|
