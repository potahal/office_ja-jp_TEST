...
## Syntax
 ...
 _表达式_. **OrganizerCopy**( ** _Source_**, ** _Destination_**, ** _Name_**, ** _Object_** )
...
|:-----|:-----|:-----|:-----|
| _Source_|必需|**String**|The document or template file name that contains the item you want to copy.|
| _Destination_|必需|**String**|The document or template file name to which you want to copy an item.|
| _Name_|必需|**String**|The name of the AutoText entry, toolbar, style, or macro you want to copy.|
