...
## Syntax
 ...
 _表达式_. **AddCanvas**( ** _Left_**, ** _Top_**, ** _Width_**, ** _Height_**, ** _Anchor_** )
...
|:-----|:-----|:-----|:-----|
| _Left_|必需|**Single**|The position, in points, of the left edge of the drawing canvas, relative to the anchor.|
| _Top_|必需|**Single**|The position, in points, of the top edge of the drawing canvas, relative to the anchor.|
| _Width_|必需|**Single**|The width, in points, of the drawing canvas.|
| _Height_|必需|**Single**|The height, in points, of the drawing canvas.|
