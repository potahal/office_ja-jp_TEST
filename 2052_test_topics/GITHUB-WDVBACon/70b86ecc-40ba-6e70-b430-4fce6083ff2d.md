...
## Syntax
 ...
 _表达式_. **Private Sub object_WindowDeactivate**( ** _ByVal Doc As Document_**, ** _ByVal Wn As Window_** )
...
|:-----|:-----|:-----|:-----|
| _Doc_|必需|**Document**|The document displayed in the deactivated window.|
