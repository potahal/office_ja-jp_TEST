...
|:-----|:-----|:-----|:-----|
| _ShowMessage_|可选|**Variant**|**True** to display the message prior to sending. **False** to automatically send the message without displaying it first. The default value is **True**.|
