...
## Syntax
 ...
 _表达式_. **SetDefaultTableStyle**( ** _Style_**, ** _SetInTemplate_** )
...
|:-----|:-----|:-----|:-----|
| _Style_|必需|**Variant**|A string specifying the name of the style.|
| _SetInTemplate_|必需|**Boolean**|**True** to save the table style in the template attached to the document.|
