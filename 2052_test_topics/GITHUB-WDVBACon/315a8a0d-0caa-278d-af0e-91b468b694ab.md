...
## Syntax
 ...
 _表达式_. **SetEditingType**( ** _Index_**, ** _EditingType_** )
...
|:-----|:-----|:-----|:-----|
| _Index_|必需|**Long**|The node whose editing type is to be set.|
| _EditingType_|必需|**MsoEditingType**|The editing property of the vertex.|
