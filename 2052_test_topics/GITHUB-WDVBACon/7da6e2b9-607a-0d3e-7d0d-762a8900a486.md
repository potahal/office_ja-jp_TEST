...
## Syntax
 ...
 _表达式_. **RunLetterWizard**( ** _LetterContent_**, ** _WizardMode_** )
...
|:-----|:-----|:-----|:-----|
| _LetterContent_|可选|**Variant**|A  **[LetterContent](62a4e17a-6598-c904-f27d-817c19c04981.md)** object. Any filled properties in the **LetterContent** object show up as prefilled elements in the Letter Wizard dialog boxes. If this argument is omitted, the **GetLetterContent** method is automatically used to get a **LetterContent** object from the specified document.|
| _WizardMode_|可选|**Variant**|**True** to display the **Letter Wizard** dialog box as a series of steps with a **Next**,  **Back**, and  **Finish** button. **False** to display the **Letter Wizard** dialog box as if it were opened from the **Tools** menu (a properties dialog box with an **OK** button and a **Cancel** button). The default value is **True**.|
