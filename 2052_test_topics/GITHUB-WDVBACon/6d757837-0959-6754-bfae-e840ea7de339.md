...
## Syntax
 ...
 _表达式_. **SelectUnlinkedControls**( ** _Stream_** )
...
|:-----|:-----|:-----|:-----|
| _Stream_|可选|**CustomXMLPart**|A custom XML part reference. Setting this parameter filters the returned content controls to include only content controls that reference this  **CustomXMLPart** in their **XMLMapping** definition.|
