...
# ExchangeUser.BusinessTelephoneNumber 属性 (Outlook)

返回一个 **字符串** 表示的商务电话号码为 **[ExchangeUser](6ec117d1-7fdb-aa36-b567-1242f8238df0.md)** 。读/写。
...
此属性对应于 MAPI 属性，  **PidTagBusinessTelephoneNumber** 。
