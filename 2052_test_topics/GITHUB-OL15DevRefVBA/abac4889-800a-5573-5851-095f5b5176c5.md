...
# ExchangeUser.StateOrProvince 属性 (Outlook)

返回一个 **字符串** 表示的州或省的 **[ExchangeUser](6ec117d1-7fdb-aa36-b567-1242f8238df0.md)** 。读/写。


## 语法

 _表达式_. **StateOrProvince**
...
此属性对应于 MAPI 属性，  **PidTagStateOrProvince** 。
