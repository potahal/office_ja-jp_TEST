...
# ContactItem.AfterWrite 事件 (Outlook)
...
在 **AfterWrite** 发生事件 **[编写](934a4bac-8b75-246b-97ed-214ebd3fbd8f.md)** 事件之后。此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](16a3d7ce-0843-5eb5-bbea-df6557ceda05.md)** 事件。
