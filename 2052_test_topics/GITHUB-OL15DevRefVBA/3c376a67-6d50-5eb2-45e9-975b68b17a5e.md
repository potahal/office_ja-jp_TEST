...
# SharingItem.BeforeRead 事件 (Outlook)
 ...
 **BeforeRead** 事件发生之前 **[读取](2bcf07e6-e9c1-b3ce-118c-a2c82b48ff5f.md)** 事件。与之前前缀与其他事件，此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](b79a4c94-46cc-5571-a36d-ad537db97bcc.md)** 事件。
