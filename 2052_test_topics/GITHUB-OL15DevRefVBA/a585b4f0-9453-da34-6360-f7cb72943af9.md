...
# ReportItem.AfterWrite 事件 (Outlook)
...
在 **AfterWrite** 发生事件 **[编写](1656ff7c-85c9-f193-3312-279d35622008.md)** 事件之后。此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](934c4793-0809-65dc-4805-de28a54634cf.md)** 事件。
