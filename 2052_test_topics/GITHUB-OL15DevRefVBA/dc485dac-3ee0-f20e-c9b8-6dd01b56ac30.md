...
# ReportItem.BeforeRead 事件 (Outlook)
 ...
 **BeforeRead** 事件发生之前 **[读取](7b142bcb-dd96-a0ec-5684-b7311f34d772.md)** 事件。与之前前缀与其他事件，此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](934c4793-0809-65dc-4805-de28a54634cf.md)** 事件。
