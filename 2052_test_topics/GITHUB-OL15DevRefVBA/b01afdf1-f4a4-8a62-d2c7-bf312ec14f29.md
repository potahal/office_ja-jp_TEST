...
# TaskItem.BeforeRead 事件 (Outlook)
 ...
 **BeforeRead** 事件发生之前 **[读取](88e5e300-e036-b511-905c-f0c238c97ade.md)** 事件。与之前前缀与其他事件，此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](ff7d2655-06b5-6344-3422-4bf7be761a39.md)** 事件。
