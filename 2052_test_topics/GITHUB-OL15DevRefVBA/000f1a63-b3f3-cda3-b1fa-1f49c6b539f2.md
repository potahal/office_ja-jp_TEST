...
# TaskRequestUpdateItem.BeforeRead 事件 (Outlook)
 ...
 **BeforeRead** 事件发生之前 **[读取](f324f6b2-dda8-d481-a470-eb660614b6c1.md)** 事件。与之前前缀与其他事件，此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](9be47a73-0e85-6a60-462e-077ad9981667.md)** 事件。
