...
# TaskItem.AfterWrite 事件 (Outlook)
...
在 **AfterWrite** 发生事件 **[编写](29e38bc5-6a19-5144-55ba-207215bd5734.md)** 事件之后。此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](ff7d2655-06b5-6344-3422-4bf7be761a39.md)** 事件。
