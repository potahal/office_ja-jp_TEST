...
# AppointmentItem.BeforeRead 事件 (Outlook)
 ...
 **BeforeRead** 事件发生之前 **[读取](aa39ec06-19ed-4655-6990-e4c4c45649d5.md)** 事件。与之前前缀与其他事件，此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](9629cf4d-99e7-c751-0543-15daf41df49c.md)** 事件。
