...
# TaskRequestDeclineItem.AfterWrite 事件 (Outlook)
...
在 **AfterWrite** 发生事件 **[编写](e0abe283-c3f4-fd1a-7a41-8b1dd0f6c161.md)** 事件之后。此事件不是可以取消的。若要确定何时从内存中卸载该项目，请使用 **[Unload](2c6ac3e9-33d3-761a-be30-1963da1a73e7.md)** 事件。
