...
# RuleConditions.NotTo 属性 (Outlook)

返回与 **olConditionNotTo** **[RuleCondition.ConditionType](d695339d-5b64-dffb-652e-ac993fca4489.md)** 的 **[RuleCondition](e03f91c2-2c08-b036-104a-d6246f28bc2d.md)** 对象。只读的。
...
枚举的规则条件或例外条件的现有规则，或者在创建一个新规则来指定的条件或例外条件时，您的姓名不在 **收件人**框中，请使用返回的 **RuleCondition** 对象。
