...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Array - the array or range of data for which you want to determine the k-th largest value.|
| _Arg2_|必需|**Double**|K - the position (from the largest) in the array or cell range of data to return.|
