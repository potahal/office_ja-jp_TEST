...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Inumber - a complex number you want to raise to a power.|
| _Arg2_|必需|**Variant**|Number - the power to which you want to raise the complex number.|
