...
## Syntax
 ...
 _表达式_. **Days360**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1 - Arg2_|必需|**Variant**|The two dates between which you want to know the number of days. If start_date (Arg1) occurs after end_date (Arg2), Days360 returns a negative number. Dates should be entered by using the DATE function, or as results of other formulas or functions.|
| _Arg3_|可选|**Variant**|A boolean value that specifies whether to use the U.S. or European method in the calculation.|
