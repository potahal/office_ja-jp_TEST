...
## Syntax
 ...
 _表达式_. **Add**( ** _Title_**, ** _Range_**, ** _Password_** )
...
|:-----|:-----|:-----|:-----|
| _Title_|必需|**String**|The title of range.|
| _Range_|必需|**Range**|**Range** object. The range allowed to be edited.|
| _Password_|可选|**Variant**|The password for the range.|
