...
## Syntax
 ...
 _表达式_. **Xirr**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
![](images/awfxirr_ZA06051264.gif)where: di = the ith, or last, payment date. d1 = the 0th payment date. Pi = the ith, or last, payment. 
