...
## Syntax
 ...
 _表达式_. **Received**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
| _Arg3_|必需|**Variant**|Investment - the amount invested in the security.|
| _Arg4_|必需|**Variant**|Discount - the security's discount rate.|
...
![](images/awfrcvd_ZA06051238.gif)where: B = number of days in a year, depending on the day count basis. DSM = number of days from settlement to maturity. 
