...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**String**|Any worksheet information from which you want to remove nonprintable characters.|
 ...
 **重要信息**  The Clean function was designed to remove the first 32 nonprinting characters in the 7-bit ASCII code (values 0 through 31) from text. In the Unicode character set, there are additional nonprinting characters (values 127, 129, 141, 143, 144, and 157). By itself, the Clean function does not remove these additional nonprinting characters.
