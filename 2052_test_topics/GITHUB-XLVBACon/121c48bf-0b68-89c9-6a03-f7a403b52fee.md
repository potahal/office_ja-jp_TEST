...
## Syntax
 ...
 _表达式_ An expression that returns a **[ColorStops](e138347b-f03c-2f50-bf61-f7f2182c9681.md)** object.
...
|:-----|:-----|:-----|:-----|
| _Position_|必需|**Double**|Represents the position in which to apply the  **ColorStop**.|
