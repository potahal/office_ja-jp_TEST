...
## Syntax
 ...
 _表达式_. **SumIfs**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_**, ** _Arg7_**, ** _Arg8_**, ** _Arg9_**, ** _Arg10_**, ** _Arg11_**, ** _Arg12_**, ** _Arg13_**, ** _Arg14_**, ** _Arg15_**, ** _Arg16_**, ** _Arg17_**, ** _Arg18_**, ** _Arg19_**, ** _Arg20_**, ** _Arg21_**, ** _Arg22_**, ** _Arg23_**, ** _Arg24_**, ** _Arg25_**, ** _Arg26_**, ** _Arg27_**, ** _Arg28_**, ** _Arg29_**, ** _Arg30_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Range**|Sum_range - the range to sum.|
| _Arg2_|必需|**Range**|Criteria_range1, criteria_range2, ? - one or more ranges in which to evaluate the associated criteria.|
| _Arg3 - Arg30_|必需|**Variant**|Criteria1, criteria2, ? - one or more criteria in the form of a number, expression, cell reference, or text that define which cells will be added. For example, criteria can be expressed as 32, "32", ">32", "apples", or B4.|
