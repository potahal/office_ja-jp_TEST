...
## Syntax
 ...
 _表达式_. **RefreshData**( ** _TopicCount_** )
...
|:-----|:-----|:-----|:-----|
| _TopicCount_|必需|**Long**|The RTD server must change the value of the  **TopicCount** to the number of elements in the array returned.|
