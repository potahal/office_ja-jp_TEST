...
## Syntax
 ...
 _表达式_. **Prob**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|X_range - the range of numeric values of x with which there are associated probabilities.|
| _Arg2_|必需|**Variant**|Prob_range - a set of probabilities associated with values in x_range.|
| _Arg3_|必需|**Double**|Lower_limit - the lower bound on the value for which you want a probability.|
| _Arg4_|可选|**Variant**|Upper_limit - the optional upper bound on the value for which you want a probability.|
