...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Range**|The range of cells from which you want to count cells.|
| _Arg2_|必需|**Variant**|The criteria in the form of a number, expression, cell reference, or text that defines which cells will be counted. For example, criteria can be expressed as 32, "32", ">32", "apples", or B4.|
