...
## Syntax
 ...
 _表达式_. **MDuration**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_** )
...
| _Arg3_|必需|**Variant**|Coupon - the security's annual coupon rate.|
| _Arg4_|必需|**Variant**|Yld - the security's annual yield.|
| _Arg5_|必需|**Variant**|Frequency - the number of coupon payments per year. For annual payments, frequency = 1; for semiannual, frequency = 2; for quarterly, frequency = 4.|
| _Arg6_|可选|**Variant**|Basis - the type of day count basis to use|
