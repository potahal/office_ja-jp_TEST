...
## Syntax
 ...
 _表达式_. **ChiSq_Test**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|The range of data that contains observations to test against expected values.|
| _Arg2_|必需|**Variant**|The range of data that contains the ratio of the product of row totals and column totals to the grand total.|
