...
## Syntax
 ...
 _表达式_. **Binom_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Number_s - the number of successes in trials.|
| _Arg2_|必需|**Double**|Trials - the number of independent trials.|
| _Arg3_|必需|**Double**|Probability_s - the probability of success on each trial.|
| _Arg4_|必需|**Boolean**|Cumulative - a logical value that determines the form of the function. If cumulative is  **True**, then the **Binom_Dist** method returns the cumulative distribution function, which is the probability that there are at most number_s successes; if **False**, it returns the probability mass function, which is the probability that there are number_s successes.|
