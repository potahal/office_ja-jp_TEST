...
## Syntax
 ...
 _表达式_. **Ispmt**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Rate - the interest rate for the investment.|
| _Arg2_|必需|**Double**|Per - the period for which you want to find the interest, and must be between 1 and nper.|
| _Arg3_|必需|**Double**|Nper - the total number of payment periods for the investment.|
| _Arg4_|必需|**Double**|Pv - the present value of the investment. For a loan, pv is the loan amount.|
