...
## Syntax
 ...
 _表达式_. **Resize**( ** _RowSize_**, ** _ColumnSize_** )
...
|:-----|:-----|:-----|:-----|
| _RowSize_|可选|**Variant**|The number of rows in the new range. If this argument is omitted, the number of rows in the range remains the same.|
| _ColumnSize_|可选|**Variant**|The number of columns in the new range. If this argument is omitted, the number of columns in the range remains the same.|
