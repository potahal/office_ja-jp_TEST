...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Z - The value for which you want the distribution.|
| _Arg2_|可选|**Variant**|Cumulative - A logical value that determines the form of the function. If cumulative is TRUE, NORM_S_DIST returns the cumulative distribution function; if FALSE, it returns the probability mass function.|
