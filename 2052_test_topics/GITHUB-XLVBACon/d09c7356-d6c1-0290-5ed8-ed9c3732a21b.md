...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|A reference to a cell containing a number, or a formula that evaluates to a number.|
| _Arg2_|必需|**Double**|The number of digits to the right of the decimal point. If  _Arg2_ is negative, the number is rounded to the left of the decimal point. If you omit decimals, it is assumed to be 2.|
