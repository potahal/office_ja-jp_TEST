...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Number - an integer that describes the number of objects.|
| _Arg2_|必需|**Double**|Number_chosen - an integer that describes the number of objects in each permutation.|
