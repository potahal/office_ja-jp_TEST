...
## Syntax
 ...
 _表达式_. **Rank**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
| _Arg2_|必需|**Range**|Ref - an array of, or a reference to, a list of numbers. Nonnumeric values in ref are ignored.|
| _Arg3_|可选|**Variant**|Order - a number specifying how to rank number.|
