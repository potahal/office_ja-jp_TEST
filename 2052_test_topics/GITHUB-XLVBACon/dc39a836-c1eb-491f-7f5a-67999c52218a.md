...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Number - the value to test against step.|
| _Arg2_|可选|**Variant**|Step - the threshold value. If you omit a value for step, GESTEP uses zero.|
