...
## Syntax
 ...
 _表达式_. **ProtectedViewWindowBeforeEdit**( ** _Pvw_**, ** _Cancel_** )
...
|:-----|:-----|:-----|:-----|
| _Pvw_|必需|**[ProtectedViewWindow](6a32240c-c90b-c51a-6f8e-c3ff496b9855.md)**|The  **Protected View** window that contains the workbook that is enabled for editing.|
| _Cancel_|必需|**Boolean**|**False** when the event occurs. If the event procedure sets this argument to **True**, editing is not enabled on the workbook.|
