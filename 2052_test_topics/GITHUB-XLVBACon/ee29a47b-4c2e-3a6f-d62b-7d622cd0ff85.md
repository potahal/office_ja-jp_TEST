...
## Syntax
 ...
 _表达式_. **NegBinom_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Number_f - the number of failures.|
| _Arg2_|必需|**Double**|Number_s - the threshold number of successes.|
| _Arg3_|必需|**Double**|Probability_s - the probability of a success.|
| _Arg4_|可选|**Variant**|Cumulative - A logical value that determines the form of the function. If cumulative is TRUE, NEGBINOM_DIST returns the cumulative distribution function; if FALSE, it returns the probability density function.|
