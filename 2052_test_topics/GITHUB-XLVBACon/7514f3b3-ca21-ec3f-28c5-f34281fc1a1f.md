...
## Syntax
 ...
 _表达式_. **Ddb**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
| _Arg5_|可选|**Variant**|Factor - the rate at which the balance declines. If factor is omitted, it is assumed to be 2 (the double-declining balance method).|
 ...
 **重要信息**  All five arguments must be positive numbers.
