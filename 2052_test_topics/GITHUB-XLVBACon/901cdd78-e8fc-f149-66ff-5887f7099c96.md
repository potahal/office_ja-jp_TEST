...
## Syntax
 ...
 _表达式_. **Match**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Lookup_value - the value you use to find the value you want in a table.|
| _Arg2_|必需|**Variant**|Lookup_array - a contiguous range of cells containing possible lookup values. Lookup_array must be an array or an array reference.|
| _Arg3_|可选|**Variant**|Match_type - the number -1, 0, or 1. Match_type specifies how Microsoft Excel matches lookup_value with values in lookup_array.|
