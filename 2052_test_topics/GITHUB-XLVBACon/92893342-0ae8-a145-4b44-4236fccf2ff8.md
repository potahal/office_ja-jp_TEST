...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Array - the array or cell range of numeric values for which you want the quartile value.|
| _Arg2_|必需|**Double**|Quart - indicates which value to return.|
