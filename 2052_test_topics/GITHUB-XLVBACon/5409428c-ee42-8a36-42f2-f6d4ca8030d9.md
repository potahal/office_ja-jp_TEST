...
## Syntax
 ...
 _表达式_. **AverageIf**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Range**|One or more cells to average.|
| _Arg2_|必需|**Variant**|The criteria in the form of a number, expression, cell reference, or text that defines which cells are averaged. For example, criteria can be expressed as 32, "32", ">32", "apples", or B4.|
| _Arg3_|可选|**Variant**|The actual set of cells to average. If omitted, range is used.|
 ...
 **注释**  The AverageIf method measures central tendency, which is the location of the center of a group of numbers in a statistical distribution. The three most common measures of central tendency are:
