...
## Syntax
 ...
 _表达式_. **AccrIntM**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|The security's issue date.|
| _Arg2_|必需|**Variant**|The security's maturity date.|
| _Arg3_|必需|**Variant**|The security's annual coupon rate.|
| _Arg4_|必需|**Variant**|The security's par value. If you omit par, ACCRINTM uses $1,000.|
| _Arg5_|可选|**Variant**|The type of day count basis to use.|
