...
## Syntax
 ...
 _表达式_. **CopyFromRecordset**( ** _Data_**, ** _MaxRows_**, ** _MaxColumns_** )
...
|:-----|:-----|:-----|:-----|
| _Data_|必需|**Variant**|The  **Recordset** object to copy into the range.|
| _MaxRows_|可选|**Variant**|The maximum number of records to copy onto the worksheet. If this argument is omitted, all the records in the  **Recordset** object are copied.|
| _MaxColumns_|可选|**Variant**|The maximum number of fields to copy onto the worksheet. If this argument is omitted, all the fields in the  **Recordset** object are copied.|
