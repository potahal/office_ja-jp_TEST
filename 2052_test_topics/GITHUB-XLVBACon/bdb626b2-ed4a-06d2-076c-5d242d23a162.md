...
## Syntax
 ...
 _表达式_. **Edit**( ** _WriteResPassword_**, ** _UpdateLinks_** )
...
|:-----|:-----|:-----|:-----|
| _WriteResPassword_|可选|**Variant**|The password required to write to a write-reserved workbook. If this argument is omitted and the workbook requires a password, the user will be prompted for the password.|
