...
## Syntax
 ...
 _表达式_. **Binom_Inv**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|Trials - the number of Bernoulli trials.|
| _Arg2_|必需|**Double**|Probability_s - the probability of a success on each trial.|
| _Arg3_|必需|**Double**|Alpha - the criterion value.|
