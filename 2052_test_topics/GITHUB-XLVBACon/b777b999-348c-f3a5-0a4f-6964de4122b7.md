...
## Syntax
 ...
 _表达式_. **T_Test**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
| _Arg3_|必需|**Double**|Tails - Specifies the number of distribution tails. If tails = 1, T_TEST uses the one-tailed distribution. If tails = 2, T_TEST uses the two-tailed distribution.|
