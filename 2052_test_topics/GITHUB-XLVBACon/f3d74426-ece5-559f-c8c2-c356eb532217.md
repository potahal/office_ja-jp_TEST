...
|:-----|:-----|:-----|:-----|
| _Down_|可选|**Variant**|The number of pages to scroll the contents down.|
| _Up_|可选|**Variant**|The number of pages to scroll the contents up.|
| _ToRight_|可选|**Variant**|The number of pages to scroll the contents to the right.|
| _ToLeft_|可选|**Variant**|The number of pages to scroll the contents to the left.|
