...
## Syntax
 ...
 _表达式_. **Add**( ** _Start_**, ** _Length_**, ** _Text_** )
...
|:-----|:-----|:-----|:-----|
| _Start_|必需|**Long**|The position that represents the first character in the specified cell.|
| _Length_|必需|**Long**|The number of characters from the  **Start** position to the end of the text in the cell.|
| _Text_|必需|**String**|Collectively, the characters that represent the phonetic text in the cell.|
