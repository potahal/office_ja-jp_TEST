 ...
 **注释**  When using  **AutoFilter** with dates, the format should be consistent with English date separators ("/") instead of local settings ("."). A valid date would be "2/2/2007", whereas "2.2.2007" is invalid.


 **注释**  Working with objects (e g  **Interior** Object) requires adding a reference to an object. You will find more information about assigning an Object reference to a variable or property in the[Set 语句](http://msdn.microsoft.com/library/59de2927-b338-0038-50b9-3379d7331935%28Office.15%29.aspx).
