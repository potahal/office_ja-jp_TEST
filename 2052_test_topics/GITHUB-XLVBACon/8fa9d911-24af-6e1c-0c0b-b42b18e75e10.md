...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Known_y's - the dependent set of observations or data.|
| _Arg2_|必需|**Variant**|Known_x's - the independent set of observations or data.|
...
![](images/awfintc1_ZA06051174.gif)where the slope, b, is calculated as: 
