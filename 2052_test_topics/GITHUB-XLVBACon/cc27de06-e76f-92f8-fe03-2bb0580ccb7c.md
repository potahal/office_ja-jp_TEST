...
## Syntax
 ...
 _表达式_. **Gamma_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|X - the value at which you want to evaluate the distribution.|
| _Arg2_|必需|**Double**|Alpha - a parameter to the distribution.|
| _Arg3_|必需|**Double**|Beta - a parameter to the distribution. If beta = 1, GAMMA_DIST returns the standard gamma distribution.|
| _Arg4_|必需|**Boolean**|Cumulative - a logical value that determines the form of the function. If cumulative is TRUE, GAMMA_DIST returns the cumulative distribution function; if FALSE, it returns the probability density function.|
