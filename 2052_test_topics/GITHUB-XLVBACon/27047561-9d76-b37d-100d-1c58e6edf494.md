...
|:-----|:-----|:-----|:-----|
| _Volatile_|可选|**Variant**|**True** to mark the function as volatile. **False** to mark the function as nonvolatile. The default value is **True**|
