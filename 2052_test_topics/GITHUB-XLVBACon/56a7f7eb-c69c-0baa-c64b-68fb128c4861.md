...
## Syntax
 ...
 _表达式_. **Percentile_Exc**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Array - The array or range of data that defines relative standing.|
| _Arg2_|必需|**Double**|K - The percentile value in the range 0..1, exclusive.|
