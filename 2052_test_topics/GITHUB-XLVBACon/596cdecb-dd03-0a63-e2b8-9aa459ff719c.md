...
## Syntax
 ...
 _表达式_. **Modify**( ** _Location_**, ** _SourceData_** )
...
|:-----|:-----|:-----|:-----|
| _Location_|必需|**Range**|The  **[Range](b8207778-0dcc-4570-1234-f130532cc8cd.md)** object that represents the location of the sparkline group.|
| _SourceData_|必需|**String**|The range that represents the source data for the sparkline group.|
