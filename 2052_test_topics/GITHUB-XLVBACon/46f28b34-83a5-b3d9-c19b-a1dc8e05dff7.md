...
## Syntax
 ...
 _表达式_. **Add**( ** _Left_**, ** _Top_**, ** _Width_**, ** _Height_** )
...
|:-----|:-----|:-----|:-----|
| _Left_|必需|**Double**|The initial coordinates of the new object (in points), relative to the upper-left corner of cell A1 on a worksheet or to the upper-left corner of a chart.|
| _Width_|必需|**Double**|The initial size of the new object, in points.|
