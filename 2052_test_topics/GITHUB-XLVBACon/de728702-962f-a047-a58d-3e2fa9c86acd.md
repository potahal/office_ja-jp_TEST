...
## Syntax
 ...
 _表达式_. **XmlDataQuery**( ** _XPath_**, ** _SelectionNamespaces_**, ** _Map_** )
...
| _Map_|可选|**Variant**|Specify an  **[XmlMap](39b0823f-0068-d8df-e4e1-ca62b55d58f5.md)** if you want to query for the XPath within a specific map.|
