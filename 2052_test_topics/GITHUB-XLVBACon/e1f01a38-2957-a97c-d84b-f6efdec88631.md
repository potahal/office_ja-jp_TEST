...
For more information about the new function, see the [F_Test](193fefdf-28f9-6635-19ec-10c8f655eaf1.md) method.

## Syntax

 _表达式_. **FTest**( ** _Arg1_**, ** _Arg2_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Array1 - the first array or range of data.|
| _Arg2_|必需|**Variant**|Array2 - the second array or range of data.|
