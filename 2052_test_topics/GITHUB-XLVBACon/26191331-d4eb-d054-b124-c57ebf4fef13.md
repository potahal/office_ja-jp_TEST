...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Known_y's - an array or cell range of numeric dependent data points.|
| _Arg2_|必需|**Variant**|Known_x's - the set of independent data points.|
