...
## Syntax
 ...
 _表达式_. **Price**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_**, ** _Arg7_** )
...
| _Arg3_|必需|**Variant**|Rate - the security's annual coupon rate.|
| _Arg4_|必需|**Variant**|Yld - the security's annual yield.|
| _Arg5_|必需|**Variant**|Redemption - the security's redemption value per $100 face value.|
| _Arg6_|必需|**Variant**|Frequency - the number of coupon payments per year. For annual payments, frequency = 1; for semiannual, frequency = 2; for quarterly, frequency = 4.|
