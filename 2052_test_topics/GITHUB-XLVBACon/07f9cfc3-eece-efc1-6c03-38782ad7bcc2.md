...
## Syntax
 ...
 _表达式_. **ChangeFileAccess**( ** _Mode_**, ** _WritePassword_**, ** _Notify_** )
...
|:-----|:-----|:-----|:-----|
| _Mode_|必需|**[XlFileAccess](7b4a7dc7-11c2-dea9-5e04-dcabe6530ee0.md)**|Specifies the new access mode.|
| _WritePassword_|可选|**Variant**|Specifies the write-reserved password if the file is write reserved and  _Mode_ is **xlReadWrite**. Ignored if there's no password for the file or if _Mode_ is **xlReadOnly**.|
| _Notify_|可选|**Variant**|**True** (or omitted) to notify the user if the file cannot be immediately accessed.|
