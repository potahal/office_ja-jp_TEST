...
|:-----|:-----|:-----|:-----|
| _Keys_|必需|**Variant**|The key or key combination you want to send to the application, as text.|
| _Wait_|可选|**Variant**|**True** to have Microsoft Excel wait for the keys to be processed before returning control to the macro. **False** (or omitted) to continue running the macro without waiting for the keys to be processed.|
