...
## Syntax
 ...
 _表达式_. **AddPivotTable**( ** _PivotTable_** )
...
|:-----|:-----|:-----|:-----|
| _PivotTable_|必需|**PivotTable**|A  **[PivotTable](a9c1d4a0-78a9-f9a6-6daf-91cb63e45842.md)** object that represents the PivotTable to add.|
