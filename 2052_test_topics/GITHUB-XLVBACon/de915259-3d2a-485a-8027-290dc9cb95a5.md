...
## Syntax
 ...
 _表达式_. **Forecast_ETS**( _Arg1_,  _Arg2_,  _Arg3_,  _Arg4_,  _Arg5_,  _Arg6_)
...
| _Arg4_|可选|VARIANT|Seasonality: A numeric value. See Remarks.|
| _Arg5_|可选|VARIANT|Data completions: Although the timeline requires a constant step between data points,  **Forecast_ETS** supports up to 30% missing data, and automatically adjusts for it. See Remarks.|
| _Arg6_|可选|VARIANT|Aggregation: Although the timeline requires a constant step between data points,  **Forecast_ETS** aggregates multiple points that have the same time stamp. See Remarks.|
