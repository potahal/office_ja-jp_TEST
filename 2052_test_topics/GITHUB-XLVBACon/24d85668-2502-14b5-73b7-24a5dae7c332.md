 ...
 **重要信息**  This function has been replaced with one or more new functions that may provide improved accuracy and whose names better reflect their usage. This function is still available for compatibility with earlier versions of Excel. However, if backward compatibility is not required, you should consider using the new functions from now on, because they more accurately describe their functionality.For more information about the new function, see the [Z_Test](86c2af95-965f-f249-7775-65ff5c41785d.md) method.


## Syntax

 _表达式_. **ZTest**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Array is the array or range of data against which to test the hypothesized population mean.|
| _Arg2_|必需|**Double**| The value to test.|
| _Arg3_|可选|**Variant**|Sigma - the population (known) standard deviation. If omitted, the sample standard deviation is used.|
