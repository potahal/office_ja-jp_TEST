...
## Syntax
 ...
 _表达式_. **YieldDisc**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
| _Arg3_|必需|**Variant**|Pr - the security's price per $100 face value.|
| _Arg4_|必需|**Variant**|Redemption - the security's redemption value per $100 face value.|
| _Arg5_|可选|**Variant**|Basis - the type of day count basis to use.|
