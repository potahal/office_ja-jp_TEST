...
## Syntax
 ...
 _表达式_. **NavigateArrow**( ** _TowardPrecedent_**, ** _ArrowNumber_**, ** _LinkNumber_** )
...
|:-----|:-----|:-----|:-----|
| _TowardPrecedent_|可选|**Variant**|Specifies the direction to navigate:  **True** to navigate toward precedents, **False** to navigate toward dependent.|
| _ArrowNumber_|可选|**Variant**|Specifies the arrow number to navigate; corresponds to the numbered reference in the cell's formula.|
| _LinkNumber_|可选|**Variant**|If the arrow is an external reference arrow, this argument indicates which external reference to follow. If this argument is omitted, the first external reference is followed.|
