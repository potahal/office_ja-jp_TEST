...
## Syntax
 ...
 _表达式_. **BeforeRightClick**( ** _Target_**, ** _Cancel_** )
...
|:-----|:-----|:-----|:-----|
| _Target_|必需|**Range**|The cell nearest to the mouse pointer when the right-click occurs.|
| _Cancel_|必需|**Boolean**|**False** when the event occurs. If the event procedure sets this argument to **True**, the default right-click action doesn't occur when the procedure is finished.|
