...
## Syntax
 ...
 _表达式_. **CreatePivotChart** _(ChartDestination,_ _XlChartType,_ _Left,_ _Top,_ _Width,_ _Height)_

 _表达式_ A variable that represents a[PivotCache Object (Excel)](c3d84ef1-f9e6-b1bc-cbf0-3ba8dfe17439.md) object.
...
|:-----|:-----|:-----|:-----|
| _ChartDestination_|必需|VARIANT|The Destination worksheet|
...
| _Top_|可选|VARIANT|The distance, in points, from the top edge of the topmost shape in the shape range to the top edge of the worksheet.|
