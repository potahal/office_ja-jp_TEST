...
## Syntax
 ...
 _表达式_. **Beta_Inv**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|A probability associated with the beta distribution.|
| _Arg2_|必需|**Double**|The Alpha parameter of the distribution.|
| _Arg3_|必需|**Double**|The Beta parameter the distribution.|
| _Arg4_|可选|**Variant**|An optional lower bound to the interval of x.|
| _Arg5_|可选|**Variant**|An optional upper bound to the interval of x.|
