...
## Syntax
 ...
 _表达式_. **OddLPrice**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_**, ** _Arg7_**, ** _Arg8_** )
...
| _Arg3_|必需|**Variant**|Last_interest - the security's last coupon date.|
| _Arg4_|必需|**Variant**|Rate - the security's interest rate.|
| _Arg5_|必需|**Variant**|Yld - the security's annual yield.|
| _Arg6_|必需|**Variant**|Redemption - the security's redemption value per $100 face value.|
| _Arg7_|必需|**Variant**|Frequency - the number of coupon payments per year. For annual payments, frequency = 1; for semiannual, frequency = 2; for quarterly, frequency = 4.|
| _Arg8_|可选|**Variant**|Basis - the type of day count basis to use.|
