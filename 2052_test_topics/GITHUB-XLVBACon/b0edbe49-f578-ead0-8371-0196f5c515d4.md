...
## Syntax
 ...
 _表达式_. **XmlImportXml**( ** _Data_**, ** _ImportMap_**, ** _Overwrite_**, ** _Destination_** )
...
|:-----|:-----|:-----|:-----|
| _Data_|必需|**String**|The data to import.|
| _ImportMap_|必需|**[XmlMap](39b0823f-0068-d8df-e4e1-ca62b55d58f5.md)**|The schema map to apply when importing the file.|
...
| _Destination_|可选|**Variant**|Specifies the range where the list will be created. Excel only uses the top left corner of the range.|
