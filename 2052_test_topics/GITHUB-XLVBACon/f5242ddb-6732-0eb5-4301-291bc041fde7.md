...
## Syntax
 ...
 _表达式_. **YieldMat**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_** )
...
| _Arg3_|必需|**Variant**|Issue - the security's issue date, expressed as a serial date number.|
| _Arg4_|必需|**Variant**|Rate - the security's interest rate at date of issue.|
| _Arg5_|必需|**Variant**|Pr - the security's price per $100 face value.|
