...
## Syntax
 ...
 _表达式_. **AmorDegrc**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_**, ** _Arg5_**, ** _Arg6_**, ** _Arg7_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|The cost of the asset.|
| _Arg2_|必需|**Variant**|The date of the purchase of the asset.|
| _Arg3_|必需|**Variant**|The date of the end of the first period.|
| _Arg4_|必需|**Variant**|The salvage value at the end of the life of the asset.|
| _Arg5_|必需|**Variant**|The period.|
| _Arg6_|必需|**Variant**|The rate of depreciation.|
| _Arg7_|可选|**Variant**|The year basis to be used.|
