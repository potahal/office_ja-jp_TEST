...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Known_y's - an array or range of dependent data points.|
| _Arg2_|必需|**Variant**|Known_x's - an array or range of independent data points.|
