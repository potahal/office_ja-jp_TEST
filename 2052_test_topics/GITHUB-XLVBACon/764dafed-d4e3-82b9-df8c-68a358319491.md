...
## Syntax
 ...
 _表达式_. **Add**( ** _SourceType_**, ** _Source_**, ** _LinkSource_**, ** _HasHeaders_**, ** _Destination_** )
...
|:-----|:-----|:-----|:-----|
| _SourceType_|可选|**[XlListObjectSourceType](5367ca5c-a5c5-a838-5493-976c1512b1fc.md)**|Indicates the kind of source for the query. |
 ...
 **注释**  The following code example assumes that you will substitute a valid server name and the list guid in the variables  `strServerName` and `strListGUID`. Additionally, the server name must be followed by "/_vti_bin" or the sample will not work.
