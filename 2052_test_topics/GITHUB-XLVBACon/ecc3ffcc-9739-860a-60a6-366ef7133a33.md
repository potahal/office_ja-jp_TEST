...
## Syntax
 ...
 _表达式_. **Growth**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
| _Arg3_|可选|**Variant**|New_x's - new x-values for which you want GROWTH to return corresponding y-values.|
| _Arg4_|可选|**Variant**|Const - a logical value specifying whether to force the constant b to equal 1.|
