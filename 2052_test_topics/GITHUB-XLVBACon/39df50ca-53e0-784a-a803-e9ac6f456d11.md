...
## Syntax
 ...
 _表达式_. **ProtectedViewWindowDeactivate**( ** _Pvw_** )
...
|:-----|:-----|:-----|:-----|
| _Pvw_|必需|**[ProtectedViewWindow](6a32240c-c90b-c51a-6f8e-c3ff496b9855.md)**|An object that represents the deactivated  **Protected View** window.|
