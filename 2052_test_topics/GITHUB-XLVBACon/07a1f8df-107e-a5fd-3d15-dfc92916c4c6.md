 ...
 **注释**   The **IsValid** property will return **True** if the PivotTable is not currently connected to the data source. Use the **[MakeConnection](d0b29374-4d5a-7d9e-630a-500b505da1bd.md)** method before testing the **IsValid** property.
