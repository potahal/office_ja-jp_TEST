...
## Syntax
 ...
 _表达式_. **Convert**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|The value in from_units to convert.|
| _Arg2_|必需|**Variant**|The units for number.|
| _Arg3_|必需|**Variant**|The units for the result. Convert accepts the following text values (in quotation marks) for from_unit and to_unit which are listed in the Remarks section below.|
