...
|:-----|:-----|:-----|:-----|
| _Type_|可选|**Variant**|Specifies the axis to return. Can be one of the following  **[XlAxisType](4c8654a8-2268-3c1d-ea24-6c79153a69ec.md)** constants: **xlValue**, **xlCategory**, or **xlSeriesAxis** ( **xlSeriesAxis** is valid only for 3-D charts).|
| _AxisGroup_|可选|**[XlAxisGroup](30e0b817-547f-70f8-6e27-4a14031d1d79.md)**|Specifies the axis group. If this argument is omitted, the primary group is used. 3-D charts have only one axis group.|
