...
## Syntax
 ...
 _表达式_. **NetworkDays**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
| _Arg2_|必需|**Variant**|End_date - a date that represents the end date.|
| _Arg3_|可选|**Variant**|Holidays - an optional range of one or more dates to exclude from the working calendar, such as state and federal holidays and floating holidays. The list can be either a range of cells that contains the dates or an array constant of the serial numbers that represent the dates.|
