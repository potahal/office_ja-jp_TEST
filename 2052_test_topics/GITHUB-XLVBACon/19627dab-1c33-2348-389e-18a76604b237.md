...
## Syntax
 ...
 _表达式_. **Expon_Dist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Double**|X - the value of the function.|
| _Arg2_|必需|**Double**|Lambda - the parameter value.|
| _Arg3_|必需|**Boolean**|Cumulative - a logical value that indicates which form of the exponential function to provide. If cumulative is TRUE, EXPONDIST returns the cumulative distribution function; if FALSE, it returns the probability density function.|
