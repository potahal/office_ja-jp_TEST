...
## Syntax
 ...
 _表达式_. **OnRepeat**( ** _Text_**, ** _Procedure_** )
...
|:-----|:-----|:-----|:-----|
| _Text_|必需|**String**|The text that appears with the  **Repeat** command.|
| _Procedure_|必需|**String**|The name of the procedure that will be run when you choose the  **Repeat** command.|
