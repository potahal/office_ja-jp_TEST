...
## Syntax
 ...
 _表达式_. **GammaDist**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
| _Arg3_|必需|**Double**|Beta - a parameter to the distribution. If beta = 1, GAMMADIST returns the standard gamma distribution.|
| _Arg4_|必需|**Boolean**|Cumulative - a logical value that determines the form of the function. If cumulative is TRUE, GAMMADIST returns the cumulative distribution function; if FALSE, it returns the probability density function.|
