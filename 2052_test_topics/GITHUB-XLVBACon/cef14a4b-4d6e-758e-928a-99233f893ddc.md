...
## Syntax
 ...
 _表达式_. **Distribute**( ** _DistributeCmd_**, ** _RelativeTo_** )
...
|:-----|:-----|:-----|:-----|
| _DistributeCmd_|必需|**[MsoDistributeCmd](http://msdn.microsoft.com/library/be0cb580-1d82-1443-0f03-3461ddb9c33d%28Office.15%29.aspx)**|Specifies whether shapes in the range are to be distributed horizontally or vertically.|
| _RelativeTo_|必需|**[MsoTriState](http://msdn.microsoft.com/library/2036cfc9-be7d-e05c-bec7-af05e3c3c515%28Office.15%29.aspx)**|Not used in Microsoft Excel. Must be  **False**.|
