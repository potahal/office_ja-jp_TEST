...
## Syntax
 ...
 _表达式_. **LogEst**( ** _Arg1_**, ** _Arg2_**, ** _Arg3_**, ** _Arg4_** )
...
|:-----|:-----|:-----|:-----|
| _Arg1_|必需|**Variant**|Known_y's - the set of y-values you already know in the relationship y = b*m^x.|
| _Arg2_|可选|**Variant**|Known_x's - an optional set of x-values that you may already know in the relationship y = b*m^x.|
| _Arg3_|可选|**Variant**|Const - a logical value specifying whether to force the constant b to equal 1.|
| _Arg4_|可选|**Variant**|Stats - a logical value specifying whether to return additional regression statistics.|
