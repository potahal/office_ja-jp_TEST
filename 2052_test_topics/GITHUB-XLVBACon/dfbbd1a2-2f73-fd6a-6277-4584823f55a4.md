...
## Syntax
 ...
 _表达式_. **Offset**( ** _RowOffset_**, ** _ColumnOffset_** )
...
|:-----|:-----|:-----|:-----|
| _RowOffset_|可选|**Variant**|The number of rows (positive, negative, or 0 (zero)) by which the range is to be offset. Positive values are offset downward, and negative values are offset upward. The default value is 0.|
| _ColumnOffset_|可选|**Variant**|The number of columns (positive, negative, or 0 (zero)) by which the range is to be offset. Positive values are offset to the right, and negative values are offset to the left. The default value is 0.|
