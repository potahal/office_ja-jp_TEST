...
## Syntax
 ...
 _表达式_. **SheetPivotTableBeforeDiscardChanges**( ** _Sh_**, ** _TargetPivotTable_**, ** _ValueChangeStart_**, ** _ValueChangeEnd_** )
...
|:-----|:-----|:-----|:-----|
| _Sh_|必需|**Object**||
| _TargetPivotTable_|必需|**[PivotTable](a9c1d4a0-78a9-f9a6-6daf-91cb63e45842.md)**|The PivotTable that contains the changes to discard.|
