...
|**[Error.code](http://msdn.microsoft.com/ja-jp/library/286f88ad-77c1-4353-a439-4faf142a72b8%28Office.15%29.aspx)**|**[Error.name](http://msdn.microsoft.com/ja-jp/library/b76aaafd-bb34-4853-b29d-67adb1111b37%28Office.15%29.aspx)**|**[Error.message](http://msdn.microsoft.com/ja-jp/library/594e168e-4fdf-4e80-ba7e-4856a4a8ea5f%28Office.15%29.aspx)**|**状態**|
|:-----|:-----|:-----|:-----|
...
|3010|サポートされないバインド操作|選択するコンテンツはテーブル形式にする必要があります。 データをテーブルとして書式設定して、もう一度やり直してください。|開発者が強制型変換タイプ  _matrix_ のデータ上の **TableBinding** オブジェクトの **addRowsAsynch** メソッドまたは **deleteAllDataValuesAsynch** メソッドを使用しようとしています。|
